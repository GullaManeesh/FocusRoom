      ...
      <div className="relative z-10 p-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-300">Ready to dive into your focus zone?</p>
          </div>
          <div className="flex items-center space-x-4">
            <button
              onClick={() => setShowFocusPrompt(true)}
              className="bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 px-6 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center space-x-2"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {[
            ...
            >
              ...
              {card.unit && (
                <div className="text-gray-400 text-sm">{card.unit}</div>
              )}
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="lg:col-span-2 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-6 hover:bg-white/20 transition-all duration-300">
            <h3 className="text-xl font-semibold mb-6">Weekly Focus Hours</h3>
          ...
          {/* Focus Streak */}
          <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-6 hover:bg-white/20 transition-all duration-300">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-400 mb-6">consecutive days</div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-8 max-w-md w-full mx-4">
              ...
              <div className="space-y-4">
                <button
                  ...
                  className="w-full bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 px-6 py-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center space-x-2"
                >
                  <Target className="w-5 h-5 text-blue-400" />
                  <span>Enter Focus Mode</span>
                </button>
                <button
                  ...
                  className="w-full bg-white/10 hover:bg-white/20 px-6 py-4 rounded-xl font-semibold transition-all duration-300 border border-white/20"
                >
                  Maybe Later
                </button>
              </div>
